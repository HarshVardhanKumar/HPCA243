...
void l2c_spp_prefetch_operate(uint64_t addr, uint64_t ip, uint8_t cache_hit, uint8_t type, uint32_t metadata_in){
...
uint32_t CACHE::l2c_prefetcher_operate(uint64_t addr, uint64_t ip, uint8_t cache_hit, uint8_t type, uint32_t metadata_in){
    if (GHR.SppVSBingo){
        ...
        l2c_bingo_prefetch_operate(addr,ip, cache_hit, type, metadata_in);
